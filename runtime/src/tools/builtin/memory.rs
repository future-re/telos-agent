...
impl Tool for MemoryWriteTool {
    ...
    async fn invoke(&self, args: Value, _: ToolContext) -> Result<ToolOutput, AgentError> {
        ...
        let status = match status_str {
            "working" => crate::knowledge::memory::MemoryStatus::Working,
            "needs_fix" => crate::knowledge::memory::MemoryStatus::NeedsFix,
            "deprecated" => crate::knowledge::memory::MemoryStatus::Deprecated,
        ...
        let category = match cat_str.as_str() {
            "script" => crate::knowledge::memory::MemoryCategory::Script,
            "command" => crate::knowledge::memory::MemoryCategory::Command,
            "pattern" => crate::knowledge::memory::MemoryCategory::Pattern,
            "fact" => crate::knowledge::memory::MemoryCategory::Fact,
            "workflow" => crate::knowledge::memory::MemoryCategory::Workflow,
