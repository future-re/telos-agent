...
| Built-in tools | `register_core_tools`, `ShellTool`, `PowerShellTool`, file tools, code index tools, browser tools, `WebFetchTool`, `WebSearchTool` | Add default filesystem, shell, search, browser, and web tools. |
