...
use crate::tools::command_security::bash::parser::Node;
use crate::tools::command_security::bash::{CommandSafety, analyze as analyze_command};
...
mod tests {
    use super::*;
    use crate::tools::command_security::bash::parser;
