...
whenToUse: When encountering an issue where root cause is not immediately obvious. Skip for obvious one-step fixes such as typos, wrong variables, missing imports, or clear errors with known fixes.
prompt: |
