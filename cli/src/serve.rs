...
fn event_variant_name(event: &telos_agent::TurnEvent) -> &'static str {
    match event {
        ...
        telos_agent::TurnEvent::CompactionFailed { .. } => "CompactionFailed",
        ...
        telos_agent::TurnEvent::PolicyRejected { .. } => "PolicyRejected",
        telos_agent::TurnEvent::PolicyFailed { .. } => "PolicyFailed",
