...
use crate::model::message::{ContentBlock, Message, Role, ToolCall};
use crate::model::provider::{CompletionRequest, ModelHint, ModelProvider};
...
mod tests {
    use super::*;
    use crate::model::message::{TextBlock, ToolCall, ToolResult};
    use crate::model::mock::MockProvider;
    use crate::model::provider::{
        CompletionResponse, DeepSeekConfig, DeepSeekProvider, StopReason,
    };
    ...
    const TEST_SUMMARY_FIXTURE: &str = include_str!(concat!(
