...
use crate::orchestration::subagent::SubagentRegistry;
use crate::tools::api::{
...
mod tests {
    ...
    async fn subagent_type_selects_agent_prompt_and_result_metadata() {
        let provider =
            Arc::new(MockProvider::new(vec![crate::model::provider::CompletionResponse {
                message: crate::Message::assistant("explore result"),
                stop_reason: crate::model::provider::StopReason::EndTurn,
                usage: None,
                model: None,
            }]));
    ...
    async fn subagent_progress_is_attached_to_parent_tool_call_with_data() {
        let provider = Arc::new(MockProvider::new(vec![
            crate::model::provider::CompletionResponse {
                ...
                stop_reason: crate::model::provider::StopReason::ToolUse,
                usage: None,
                model: None,
            },
            crate::model::provider::CompletionResponse {
