...
impl crate::agent::prompt::PromptSection for PluginPromptSection {
    fn name(&self) -> &str {
        &self.name
    }
    fn stability(&self) -> crate::agent::prompt::PromptStability {
        crate::agent::prompt::PromptStability::Static
    }
