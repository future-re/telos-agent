...
use crate::tools::command_security::bash::extract_command_prefix;
use crate::tools::command_security::bash::prefix::PrefixResult;
    ...
    pub fn evaluate_shell_call(
        ...
        let extracted = match shell_kind {
            ...
            ShellKind::PowerShell => {
                match crate::tools::command_security::powershell::extract_command_prefix(command) {
                    crate::tools::command_security::powershell::PrefixResult::Prefix(p) => Some(p),
                    crate::tools::command_security::powershell::PrefixResult::None => None,
                    crate::tools::command_security::powershell::PrefixResult::NeedsReview => {
                        return self.evaluate_needs_review_shell(tool_names, cwd);
                    }
                }
            }
