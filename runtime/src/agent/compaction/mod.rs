...
//! - [`message_truncation`] — per-message truncation.
//! - [`history_summary`] — history-level summarisation.
//!
//! The runtime applies both during turns started by [`AgentRuntime`](crate::AgentRuntime).
